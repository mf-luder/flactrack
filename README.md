...
Installing the script is as simple as downloading it, making it executable, and putting it in your path (for Linux I recommend /usr/local/bin/). Make sure that you also have the Xiph command line flac encoder/decoder program. Repeat the installation process, overwriting the original file, for updates. To uninstall the script, simply delete the file.
